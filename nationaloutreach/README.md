...
### Jewel-Osco Tasting Policy

Jewel tastings must follow the TAB Demo Request process from Sonat's 2026-06-22 Jewel source email before Vanessa finalizes a schedule. Fill out the TAB Demo Request form completely, including proposed store numbers, dates, times, product details, and UPCs. Send the completed request sheet to the Jewel TAB contacts named in the source thread for store approval with at least three weeks lead time.

After approvals come back, finalize the schedule with the demo agency only from the approved sheet. The demo agency must contact the store Liquor Manager at least 24 hours before the tasting to confirm approval, and any product being sent into the store must be coordinated with the Liquor Manager one week before the tasting. Sonat's warning in the source thread says noncompliance can block live Jewel tastings for six months.
