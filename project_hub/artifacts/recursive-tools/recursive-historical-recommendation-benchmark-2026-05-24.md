...
- python-migration-complete-clean: `pass`
  ...
  - State: `parity_drift=0; truth_drift=0; cleanup_active_elsewhere=False; registry_ok=True; coverage_ok=True; skill_loop_proven=True`
...
- service-parity-drift-broad-runtime: `pass`
  ...
  - State: `parity_drift=48; truth_drift=0; cleanup_active_elsewhere=False; registry_ok=True; coverage_ok=True; skill_loop_proven=False`
...
- truth-drift-cleanout-active: `pass`
  ...
  - State: `parity_drift=0; truth_drift=17; cleanup_active_elsewhere=True; registry_ok=True; coverage_ok=True; skill_loop_proven=True`
...
- truth-drift-single-open-item: `pass`
  ...
  - State: `parity_drift=0; truth_drift=1; cleanup_active_elsewhere=False; registry_ok=True; coverage_ok=True; skill_loop_proven=True`
...
- registry-coverage-contract-added: `pass`
  ...
  - State: `parity_drift=0; truth_drift=0; cleanup_active_elsewhere=False; registry_ok=False; coverage_ok=False; skill_loop_proven=True`
...
- local-skill-loop-not-yet-proven: `pass`
  ...
  - State: `parity_drift=0; truth_drift=0; cleanup_active_elsewhere=False; registry_ok=True; coverage_ok=True; skill_loop_proven=False`
...
- Cases file: `sandboxes/recursive-improve-pilot-target-313/recommendation_historical_cases.json`
- Runner: `sandboxes/recursive-improve-pilot-target-313/run_historical_recommendation_benchmark.py`
- Trace directory: `sandboxes/recursive-improve-pilot-target-313/eval/historical-recommendation-traces`
- Eval output directory: `sandboxes/recursive-improve-pilot-target-313/eval/historical-recommendation-benchmark`
