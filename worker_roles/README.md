...
- `barrel-sales-manager.md`: WH Barrel Program and barrel-sample workflow manager for reservations, sample requests, sold state, bottling details, prior-buyer contact review, sample conversion reporting, and Sonat/Avignon barrel-program follow-through.
- `finance-analyst.md`: BID finance and reporting role.
- `naomi-stern.md`: Finance Operations Coordinator for finance operating cadence, controls, close readiness, and finance follow-through; canonical persona `naomi-stern/persona.yaml`.
- `ezra-katz.md`: Special Projects & Legal Affairs coordinator for special-project follow-through, document/legal-affairs routing, approval tracking, and counsel-ready business briefs; canonical persona `ezra-katz/persona.yaml`.
...
- AI Manager Robert is a control lane, not an execution lane. Substantive work should be delegated to Task Manager, which creates/focuses visible Workspaceboard workers, monitors completion, and returns only real blockers, input needs, approval gates, or concise management-level closeouts.
...
- Naomi Stern / Finance Operations Coordinator owns finance operating cadence, controls, close readiness, finance follow-through, and decision questions; Finance Analyst owns analysis/reporting and deterministic BID finance implementation planning.
- Ezra Katz / Special Projects & Legal Affairs coordinates special projects, document follow-through, legal-affairs routing, approval tracking, and counsel-ready business briefs. He keeps the tone practical and does not provide final legal advice or approve legal/regulatory action.
...
- New specialist-role directive: whenever any new specialist role is added, update the role description/task docs, task/routing references, team/board model, and the Organigram graphic/map source. AI Manager Robert, AI Manager Dmytro, Marketing Manager, Barrel Sales Manager, Outreach Coordinator, Outreach Communicator, Codex Integration Manager, AI Improvement Manager, AI Health Manager, Codex Local Agent, Claude Planner Operator, Claude Papers Operator, Claude Mail Operator, Claude Agent Operations, Claude Server Agent, Claude `.205` Structure, Git and Code Manager, Security Guard, Naomi Stern, and Ezra Katz are active map entries and must stay visible in the organigram; Git and Code Manager, Security Guard, Codex Integration Manager, AI Improvement Manager, and AI Health Manager belong under Monitoring / Integration. AI Improvement Manager is approved for a Task Manager-created or prompted visible end-of-day review session only. AI Health Manager is approved for docs/source/organigram setup and future visible-session/manual checks only; any 15-minute scheduler, LaunchAgent, daemon, runtime cadence, or service activation requires a separate Code/Git/Security-reviewed implementation slice.
